...
var graphConfig = Belt_Option.getWithDefault(
  env.GRAPH_CONFIG,
  "./subgraph.yaml"
);

var codegenConfigPath = Belt_Option.getWithDefault(
  env.CODEGEN_CONFIG_PATH,
  "./config.yaml"
);

var generatedFolderName = Belt_Option.getWithDefault(
  env.GENERATED_FOLDER_NAME,
  "generated"
);

var outputTestFilePath = "./tests/" + generatedFolderName + "/";
