...
function outputCode(entityImports, networkIdPrefix, functions) {
  return (
    ...
    entityImports +
    '\n} from "../../' +
    CodegenConfig.generatedFolderName +
...
function getOrInitializeDefaultFunction(name, fieldDefaultSettersStrict) {
  return (
    ...
    name +
    'Default(entityId: string = "UNINITIALISED - ' +
    name +
    '"): ' +
    name +
...
function createEntityFunction(name, fieldInitialValueSettersStrict) {
  return (
    ...
    name +
    "(entityId: string, initialValues: " +
    name +
    "InitialValues): " +
    name +
    " {\n  entityId = makeSureEntityIdHasCorrectPrefix(entityId);\n  if (SAFE_MODE && " +
    name +
    '.load(entityId) != null) {\n    logError("THIS CODE IS BUGGY! Trying to create an entity that already exists. (entityType : ' +
    name +
    ', entitiyID: {})", [entityId]);\n\n    return ' +
    name +
    ".load(entityId) as " +
...
function getOrInitializeFunction(name) {
  return (
    ...
    "(entityId: string, initialValues: " +
    name +
    "InitialValues): GetOrCreateReturn<" +
    name +
    "> {\n  entityId = makeSureEntityIdHasCorrectPrefix(entityId);\n  let loaded" +
    name +
    " = " +
    name +
    ".load(entityId);\n\n  let returnObject: GetOrCreateReturn<" +
    name +
    ">;\n\n  if (loaded" +
    name +
    " == null) {\n    returnObject = new GetOrCreateReturn<" +
    name +
    ">(create" +
    name +
    "(entityId, initialValues), true);\n  } else {\n    returnObject = new GetOrCreateReturn<" +
    name +
    ">(loaded" +
    name +
    " as " +
...
function getFunction(name) {
  return (
    ...
    ".load(entityId);\n\n  if (loaded" +
    name +
    ' == null) {\n    logError("THIS CODE IS BUGGY! Unable to find entity of type ' +
    name +
    " with id {}. If this entity hasn't been initialized use the 'getOrInitialize" +
    name +
    "' and handle the case that it needs to be initialized.\", [entityId])\n\n    return getOrInitialize" +
    name +
    "Default(entityId);\n  }\n\n  return loaded" +
    name +
    " as " +
